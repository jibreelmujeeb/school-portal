...
export const sidebarMenus = {
  ...
  teacher: [
    ...
    { name: "Holiday Management", path: "/teacher/holiday-management", icon: CalendarDays },
  ...
  admin: [
    ...
    { name: "Outstanding Fees", path: "/admin/outstanding-fees", icon: CreditCard },
  ...
  accountant: [
    ...
    { name: "Holiday Management", path: "/accountant/holiday-management", icon: Settings },
    { name: "Receipts Management", path: "/accountant/receipts-management", icon: CreditCard },
    { name: "Budgeting", path: "/accountant/budgeting", icon: CreditCard },
    { name: "Payroll", path: "/accountant/payroll", icon: CreditCard },
  ...
  librarian: [
    ...
    { name: "Books Management", path: "/librarian/books-management", icon: BookOpen },
     { name: "Book Requests", path: "/librarian/book-requests", icon: BookOpen },
